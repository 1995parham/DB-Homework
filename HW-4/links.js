...
var link_1, link_10, link_2, link_3, link_4, link_5, link_6, link_7, link_8, link_9;
...
link_2 = {
  ...
  date: new ISODate('2013-04-30 13:23UTC'),
  starred: 105,
  ratings: [3, 5, 3, 2, 4, 1, 3, 3, 3, 2, 3],
  comments: [
    {
      user: 'tr0lltherapy',
      upVotes: 18,
      downVotes: 2,
      text: 'they\'ve made the right decision here. if people want to experiment with purity, there are already mature tools available. rust wants to focus on performance and be a tool a lot of people will use. this decision helps',
      replies: [
        {
          user: 'thedeemon',
          upVotes: 10,
  ...
  tags: ['Rust', 'Computer', 'Programming'],
  draft: true,
  published: true
};
      ...
      replies: [
        {
          ...
          upVotes: 7,
          downVotes: 0,
          text: 'Also gold is used in gccgo with the --with-ld command line option. So it\'s not like they\'re ignoring these tools at all.'
        }, {
          user: 'CameronNemo',
          upVotes: 5,
          downVotes: 1,
          text: 'EXACTLY! These projects are together on their goals and members, they should be together on their technology.'
        }, {
          user: 'idiot_with_a_gun',
          upVotes: 2,
          downVotes: 2,
          text: 'If writing Go in Go makes it easier to get compiler devs and makes it a better compiler, great! If it doesn\'t, don\'t do it!'
        }
      ]
    }, {
      user: 'Jurily',
      ...
      replies: [
        {
          ...
          upVotes: 7,
          downVotes: 3,
          text: 'See http://thread.gmane.org/gmane.comp.lang.rust.devel/3674/focus=3855 for an explanation by Graydon Hoare on why purity just didn\'t work out for Rust.'
        }
      ]
    }
  ],
  tags: ['Go', 'Computer', 'Programming'],
  draft: false,
  published: true
};
...
link_4 = {
  ...
  date: new ISODate('2013-02-19 13:23UTC'),
  starred: 1939,
  ratings: [5, 4, 2, 3, 5, 2, 3, 4, 2, 3, 1, 3, 3],
  comments: [
    {
      user: 'zip117',
      upVotes: 150,
      downVotes: 21,
      text: 'Unless you\'re Kazushige Goto. See: GotoBLAS, now maintained as OpenBLAS.',
      replies: [
        {
          ...
          upVotes: 22,
          downVotes: 1,
          text: 'I was talking to a guy who was trying to reverse engineer the techniques to apply them to another problem. Apparently, Goto uses register/instruction scheduling techniques that are hard to coerce a C compiler to use without a lot of trickery.'
        }
      ]
    }, {
      user: 'ocharis',
      upVotes: 489,
      downVotes: 12,
      text: '"I love you, mr. compiler. Now please stop caring so much about types." has 39 votes.',
      replies: [
        {
          user: 'naoprakov',
          upVotes: 12,
          downVotes: 2,
          text: 'If the compiler didn\'t worry about types, I\'m pretty sure I would have blown up my house by now.'
        }
      ]
    }, {
      ...
      upVotes: 55,
      downVotes: 2,
      text: 'While I was reading the entry its vote count kept increasing. I guess there\'s a lot of readers from here and potentially other places. I didn\'t know they broadcast increments in real-time. Cool!',
      replies: [
        {
          user: 'sebf',
          upVotes: 22,
          ...
          upVotes: 4,
          downVotes: 0,
          text: 'It\'s first spot on HN ATM. Major traffic is coming from there i suppose.'
        }, {
          user: 'sevenletters',
          upVotes: 22,
          downVotes: 2,
          text: 'It is not line count that makes the C++ compilers slow, it is how the features of the language are specified (templates, overloading, virtual methods to name three). Look at any C++ compiler\'s RAM usage - that is not because of line count, that is because of features that require extensive changes in the AST post initial parsing based on later input.'
        }
      ]
    }
  ],
  tags: ['Compilers', 'Computer'],
  draft: true,
  published: false
};
...
link_5 = {
  ...
  date: new ISODate('2012-09-12 13:23UTC'),
  starred: 19,
  ratings: [1, 2, 2, 2],
  comments: [
    {
      ...
      replies: [
        {
          ...
          upVotes: 12,
          downVotes: 4,
          text: 'I\'ve had that exact conversation with a project manager who was complaining I was taking too long: "Working 99.999% of the time isn\'t acceptable when you\'re building 100,000 a day!"'
        }
      ]
    }, {
      user: 'newstine',
      upVotes: 54,
      downVotes: 12,
      text: 'What if it\'s the same one person that everyone keeps running into with the name Null, who is some sort of programming terrorist?',
      replies: [
        {
          user: 'elephantry',
          upVotes: 12,
          downVotes: 5,
          text: 'Doesn\'t appear to be all that uncommon http://www.ancestry.com/name-origin?surname=null\nShouldn\'t that just become "The, The"?'
        }, {
          user: 'Muezza',
          upVotes: 44,
          downVotes: 3,
...
link_6 = {
  ...
  date: new ISODate('2007-09-06 13:23UTC'),
  starred: 900,
  ratings: [5, 4, 2, 5, 1, 4, 1, 2, 4, 3, 2, 5, 4, 1, 4, 5, 2],
  comments: [
    {
      user: 'ENOENT',
      upVotes: 500,
      downVotes: 145,
      text: 'You need to put it in context. There were times when lkml had occasional invasions of C++ trolls like above. People that had no idea how kernel worked, what massive effort was put to make things reliable and fast while still keeping clean, readable code base. Imagine a mailing list where participants discuss best page cache invalidation strategy, power aware scheduling schemes, lockless dcache walks, etc. and then suddenly someone pops in and tells you the biggest problem you have is lack of RAII - without having any clue what your real current problems are and how things really work.',
      replies: [
        {
          user: 'teambob',
          upVotes: 7,
          downVotes: 2,
          text: 'Git maintenance was handed over in 2005, so why is this person even asking about it in the kernel mailing list?'
        }, {
          user: 'torh',
          upVotes: 7,
          downVotes: 4,
          text: 'It\'s not from the kernel mailing list, it\'s from the git mailinglist which makes the fact that the question is from 2007 irrelevant.'
        }, {
          user: 'nomad',
          upVotes: 9,
          downVotes: 2,
          text: 'Linus makes some good points, but this post is steeped in hyperbole. It\'s one (very respected) programmer\'s opinion on the matter, but if you\'re susceptible to arguments from authority, there are equally respected programmers who would argue for the utility of (at least certain parts of) C++. I agree that for system-level programming, C is still a very strong choice. However, it\'s not prima facie obvious that a version control system is a system-level application.'
        }
      ]
    }, {
      user: 'DEADBEEF',
      ...
      replies: [
        {
          ...
          upVotes: 99,
          downVotes: 7,
          text: 'RAII is very powerful and I think Linus underestimates its usefulness. BUT it has to be said that it was the introduction of exceptions that made RAII so absolutely indispensible in C++. Adding exceptions to a non garbage collected language is a horrible mistake in my view. That this mistake has helped popularize RAII is a fortunate accident, but you can\'t blame C advocates for not appreciating a C++ feature that solves a problem that was massively exacerbated by another C++ feature that C doesn\'t have.'
        }, {
          user: 'tejp',
          upVotes: 26,
          downVotes: 0,
      ...
      replies: [
        {
          ...
          upVotes: 8,
          downVotes: 3,
          text: 'That is a good comment (for the discussion) that I belive people not used to C probably might not realize why it is relevant to the discussion. Goto is not the catch-all evil and it is surprisingly easy to make clean resource allocation cleanup on error handling using it.'
        }
      ]
    }
  ],
  ...
  comments: [
    {
      ...
      upVotes: 7,
      downVotes: 2,
      text: 'Clearly the people spending all of their time writing advent articles about how amazing it\'s going to be when it finally advents (but none of their time actually adventing it).',
      replies: [
        {
          user: 'xiong',
          upVotes: 3,
          downVotes: 0,
          text: 'I feel like they may be subconsciously procrastinating because the release of perl 6 will put to test all the claims they\'ve been making for the last decade. Right now they can say "oh, no one uses it because it\'s not finished", but when it releases and still no one uses it, what are they going to do?'
        }, {
          user: 'raiph',
          upVotes: 0,
          downVotes: 0,
          text: 'To all: educated_poo posted this reddit. Why do you think he did that?'
        }
      ]
    }, {
      user: 'raiph',
      upVotes: 0,
      downVotes: 1,
      text: 'There\'s a small community of folk who do, most of whom hang out on the freenode IRC channel #perl6.',
      replies: []
    }
  ],
  tags: ['Perl', 'Computer', 'Programming'],
  draft: false,
  published: true
};
...
link_8 = {
  ...
  title: 'All I Want for Christmas Is a New File Format for Genomics',
  body: 'R.I.P. John McCarthy, father of AI, inventor of Lisp, suddenly at home last night. Pls RT.',
  url: 'https://twitter.com/wendyg/status/128554733714669568',
  date: new ISODate('2011-10-24 13:23UTC'),
  starred: 209,
  ratings: [5, 5, 5, 5, 5],
  comments: [
    {
      ...
      replies: [
        {
          ...
          upVotes: 500,
          downVotes: 200,
          text: 'You win the award for most depressing coding analogy! Congrats!'
        }
      ]
    }, {
      user: 'lawpoop',
...
link_9 = {
  ...
  date: new ISODate('2013-11-25 13:23UTC'),
  starred: 6,
  ratings: [1, 2, 2, 2, 5, 2, 4, 3, 3],
  comments: [
    {
      user: 'superking2',
      upVotes: 300,
      downVotes: 10,
      text: '"It will never work the first time" is, in my opinion, the single most valuable piece of advice from this list that all coders need to know. If I could have understood this I would have started coding 13 years ago (instead of 2).',
      replies: [
        {
          user: 'fizzl',
          upVotes: 181,
          ...
          upVotes: 15,
          downVotes: 5,
          text: 'Surprisingly, my best project is one where I wrote the design from technical spec, which was written by my manager from customer requirements. It was executed by an experienced lead developer with two junior devs.'
        }
      ]
    }
  ],
...
link_10 = {
  ...
  date: new ISODate('2013-11-30 13:23UTC'),
  starred: 55,
  ratings: [3, 5, 4, 1, 2, 3, 2, 4, 2, 5, 5, 1],
  comments: [
    {
      user: 'hobbified',
      upVotes: 1100,
      downVotes: 90,
      text: 'They\'ve improved the world immensely by killing off expert sexchange, and that\'s all that really matters.',
      replies: [
        {
          user: 'hex',
          upVotes: 400,
          downVotes: 100,
          text: 'EDIT: w3fools.com provides a bit of context here. Generally the problem is that the information on w3schools is not kept up to date and can be wrong, or show an outdated way of doing things. A preferrable resource is the MDN'
        }, {
          user: 'Uberhipster',
          upVotes: 809,
          downVotes: 40,
          text: 'The information on there is sometimes inaccurate but it is not cast in stone. You can email them and point out the omissions/discrepancies and they will amend them as they did in lieu of w3fools. It\'s kind of nitpicky to be that anal about several examples of things on w3schools that, although correct and functional, aren\'t considered \'best practice\'.'
        }, {
          user: 'Uberhipster',
          upVotes: 250,
          downVotes: 30,
      ...
      upVotes: 4,
      downVotes: 0,
      text: 'I think MDN is a better resource for developers that are already familiar with programming concepts. I\'ve recently been teaching high schoolers how to do web development, coming from no programming background, and though my initial reaction was to point them to MDN to look things up after comparing the two on different topics I found justifying that quite difficult. Simply put, MDN has way too many details that honestly aren\'t vital to learn from, they will distract and confuse more then help.',
      replies: [
        {
          user: 'Modevs',
          upVotes: 4,
          downVotes: 1,
          text: 'Despite all the pedantic angst, for every coder whining about w3cs\' few and generally minor inaccuracies there are thousands of people Googling "html tutorial", finding w3cs\' articles and learning the fundamentals.'
        }
      ]
    }
  ],
...
db.links.save(link_1);

db.links.save(link_2);

db.links.save(link_3);

db.links.save(link_4);

db.links.save(link_5);

db.links.save(link_6);

db.links.save(link_7);

db.links.save(link_8);

db.links.save(link_9);

db.links.save(link_10);
